...
<head>
    ...
    <style>
        * {{ -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }}
        ...
        .data-col {{ flex: 1; font-size: 14px; color: inherit; }}
...
# ---------------------------------------------------------
# AJUSTE DE LA PALETA A ESCALA DE AZULES 
# ---------------------------------------------------------
NIVELES_CONFIG = [
    {'limite': 35, 'nombre': 'Crítico',   'color': '#1A2744', 'bg_color': '#1A2744', 'texto': 'white'},
    {'limite': 45, 'nombre': 'Bajo',      'color': '#1E4D8C', 'bg_color': '#1E4D8C', 'texto': 'white'},
    {'limite': 55, 'nombre': 'Medio',     'color': '#2979C4', 'bg_color': '#2979C4', 'texto': 'white'},
    {'limite': 65, 'nombre': 'Bueno',     'color': '#5BAAE8', 'bg_color': '#5BAAE8', 'texto': '#000000'},
    {'limite': 100,'nombre': 'Excelente', 'color': '#B8DEFF', 'bg_color': '#B8DEFF', 'texto': '#000000'}
]
        ...
        for materia in ['Matemática', 'Lengua']:
                    ...
                    options: {{
                        ...
                        plugins: {{
                            ...
                            datalabels: {{
                                display: true,
                                color: function(c) {{ 
                                    return c.dataset.label === 'Bueno' || c.dataset.label === 'Excelente' ? '#000000' : '#ffffff'; 
                                }},
            ...
            for grado_n in grados_num:
                ...
                for grupo in grupos:
                    ...
                    contenido_html += f"""
                    <div class="group-row">
                        <div class="group-data" style="background-color: {bg_color}; border-left: 6px solid {border_color}; color: {texto_color};">
                            <div class="data-col text-left"><strong>{label_mostrar}</strong></div>
                            <div class="data-col text-right" style="font-weight: bold; text-transform: uppercase;">{clas_sec['nombre']}</div>
                        </div>
                        <div class="spacer"></div>
