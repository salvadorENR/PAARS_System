...
def main():
    ...
    # ── Cross-merge anchor LEC rows with regular rows ─────────────────────────
    # Mirrors report_profesores.py make_fingerprint logic:
    # A regular item "6.3 Compara..." and an anchor item LEC315 whose metadata
    # says "6.3 Compara..." share the SAME objective fingerprint "obj_6.3".
    # They should appear as ONE merged row (pct = average) rather than two.
    # MAT anchor items are always kept separate (no fingerprint merging).
