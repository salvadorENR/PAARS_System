...
CAMBIO (2026-06-24):
  - FIX: En dibujar_sankey_multimes(), el subtítulo ahora usa el parámetro
    `sufijo_sankey` en lugar del valor hardcodeado "B1", de modo que los
    Sankey de B2 muestran correctamente "Población base (Grupo B2): ..."
"""
...
def dibujar_sankey_multimes(df_master, materia, meses_labels, sufijo_sankey="B1"):
    ...
    if n_centros > 0:
        ...
        # FIX: usar sufijo_sankey en lugar del valor hardcodeado "B1"
        subtitulo_html = (
            f"<span style='font-size:13px;color:#888'>"
            f"Población base (Grupo {sufijo_sankey}): {n_centros} centros<br>"
